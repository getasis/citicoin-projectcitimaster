...
uint256 hashGenesisBlock("0xdef771520de8451759dabe66105875bc17fbf456f9efcdc017a7aea2609d8e15");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 500000); // citicoin: 500k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // citicoin: 3.5 days
static const int64 nTargetSpacing = 5 * 60; // citicoin: 5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x3ecbf5e94fb4c20dbb84119949dd728c1257542351099c73c55925424f92b637");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Citicoin is the cyrptocoin trading technology";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04c1e854d719a8c35c52398bd8115b3f5a1b96ff4c235f6ede896253ef9db307b3e2e094253620e1caa9fda72fbf3eb66a0d46e0512cb0adc20f55edcbda954f12") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1527033010;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2084750702;

        if (fTestNet)
        {
            block.nTime    = 1527032952;
            block.nNonce   = 386315507;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("5c39f244c4aa41edb14bc1bbe34ad5e09e08d7cda49ca786909a60ba395b326b"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfe, 0xc6, 0xb3, 0xd9 }; // citicoin: increase each by adding 2 to bitcoin's value.
